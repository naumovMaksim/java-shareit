...
class UserServiceImplTest {
    ...
    void createTest() {
        UserDto userCreateDto = UserDto.builder()
                ...
                .build();
        Optional<UserDto> userDto = Optional.of(userService.create(UserMapper.toUser(userCreateDto)));
    ...
    void updateTest() {
        UserDto userUpdateDto = UserDto.builder()
                ...
                .build();
        Optional<UserDto> userDto = Optional.of(userService.update(UserMapper.toUser(userUpdateDto), 1L));
    ...
    void getByIdUnCorrectTest() {
        assertThrows(DataNotFoundException.class, () -> userService.getById(100L));
    }
    ...
    void getAllTest() {
        UserDto userCreateDto = UserDto.builder()
                ...
                .build();
        userService.create(UserMapper.toUser(userCreateDto));
